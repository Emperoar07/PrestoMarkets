...
const CRYPTO_LOGOS: Array<{ aliases: string[]; url: string }> = [
  ...
  // Extended coverage so crypto markets get the REAL coin mark (best-quality /large/ CoinGecko art)
  // instead of an AI illustration. A wrong/dead entry is harmless: the creation-time + backfill
  // liveness probes fetch the bytes first and fall through to AI generation if the URL 404s.
  { aliases: ['litecoin', 'ltc'], url: 'https://assets.coingecko.com/coins/images/2/large/litecoin.png' },
  { aliases: ['polkadot', 'dot'], url: 'https://assets.coingecko.com/coins/images/12171/large/polkadot.png' },
  { aliases: ['tron', 'trx'], url: 'https://assets.coingecko.com/coins/images/1094/large/tron-logo.png' },
  { aliases: ['shiba inu', 'shib'], url: 'https://assets.coingecko.com/coins/images/11939/large/shiba.png' },
  { aliases: ['polygon', 'matic', 'pol'], url: 'https://assets.coingecko.com/coins/images/4713/large/polygon.png' },
  { aliases: ['uniswap', 'uni'], url: 'https://assets.coingecko.com/coins/images/12504/large/uniswap-logo.png' },
  { aliases: ['cosmos', 'atom'], url: 'https://assets.coingecko.com/coins/images/1481/large/cosmos_hub.png' },
  { aliases: ['stellar', 'xlm'], url: 'https://assets.coingecko.com/coins/images/100/large/Stellar_symbol_black_RGB.png' },
  { aliases: ['near protocol', 'near'], url: 'https://assets.coingecko.com/coins/images/10365/large/near.jpg' },
  { aliases: ['aptos', 'apt'], url: 'https://assets.coingecko.com/coins/images/26455/large/aptos_round.png' },
  { aliases: ['arbitrum', 'arb'], url: 'https://assets.coingecko.com/coins/images/16547/large/arb.jpg' },
  { aliases: ['optimism', 'op'], url: 'https://assets.coingecko.com/coins/images/25244/large/Optimism.png' },
  { aliases: ['sui'], url: 'https://assets.coingecko.com/coins/images/26375/large/sui-ocean-square.png' },
  { aliases: ['pepe'], url: 'https://assets.coingecko.com/coins/images/29850/large/pepe-token.jpeg' },
  { aliases: ['worldcoin', 'wld'], url: 'https://assets.coingecko.com/coins/images/31069/large/worldcoin.jpeg' },
  { aliases: ['internet computer', 'icp'], url: 'https://assets.coingecko.com/coins/images/14495/large/Internet_Computer_logo.png' },
  { aliases: ['filecoin', 'fil'], url: 'https://assets.coingecko.com/coins/images/12817/large/filecoin.png' },
  { aliases: ['injective', 'inj'], url: 'https://assets.coingecko.com/coins/images/12882/large/Secondary_Symbol.png' },
  { aliases: ['sei'], url: 'https://assets.coingecko.com/coins/images/28205/large/Sei_Logo_-_Transparent.png' },
  { aliases: ['hedera', 'hbar'], url: 'https://assets.coingecko.com/coins/images/3688/large/hbar.png' },
  { aliases: ['vechain', 'vet'], url: 'https://assets.coingecko.com/coins/images/1167/large/VET_Token_Icon.png' },
  { aliases: ['algorand', 'algo'], url: 'https://assets.coingecko.com/coins/images/4380/large/download.png' },
  { aliases: ['aave'], url: 'https://assets.coingecko.com/coins/images/12645/large/aave-token-round.png' },
  { aliases: ['maker', 'mkr'], url: 'https://assets.coingecko.com/coins/images/1364/large/Mark_Maker.png' },
  { aliases: ['lido', 'ldo'], url: 'https://assets.coingecko.com/coins/images/13573/large/Lido_DAO.png' },
  { aliases: ['jupiter', 'jup'], url: 'https://assets.coingecko.com/coins/images/34188/large/jup.png' },
  { aliases: ['dogwifhat', 'wif'], url: 'https://assets.coingecko.com/coins/images/33566/large/dogwifhat.jpg' },
  { aliases: ['bonk'], url: 'https://assets.coingecko.com/coins/images/28600/large/bonk.jpg' },
  { aliases: ['render', 'rndr'], url: 'https://assets.coingecko.com/coins/images/11636/large/rndr.png' },
  { aliases: ['celestia', 'tia'], url: 'https://assets.coingecko.com/coins/images/31967/large/tia.jpg' },
  { aliases: ['bittensor', 'tao'], url: 'https://assets.coingecko.com/coins/images/28452/large/ARUsPeNQ_400x400.jpeg' },
  { aliases: ['kaspa', 'kas'], url: 'https://assets.coingecko.com/coins/images/25751/large/kaspa-icon-exchanges.png' },
  { aliases: ['ethereum classic', 'etc'], url: 'https://assets.coingecko.com/coins/images/453/large/ethereum-classic-logo.png' },
  { aliases: ['bitcoin cash', 'bch'], url: 'https://assets.coingecko.com/coins/images/780/large/bitcoin-cash-circle.png' },
  { aliases: ['monero', 'xmr'], url: 'https://assets.coingecko.com/coins/images/69/large/monero_logo.png' },
  { aliases: ['ondo'], url: 'https://assets.coingecko.com/coins/images/26580/large/ONDO.png' },
  { aliases: ['eurc', 'euro coin'], url: 'https://assets.coingecko.com/coins/images/26045/large/euro.png' },
];
